...
import type { Viewport, OHLCV } from '../types/data';
...
const CANDLESTICK_VERTEX_SHADER = `#version 300 es
...
const CANDLESTICK_FRAGMENT_SHADER = `#version 300 es
precision highp float;
...
function createCandlestickGeometry(): {
...
function createVolumeGeometry(): Float32Array {
